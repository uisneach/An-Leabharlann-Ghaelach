...
// Properties that are autogenerated by the DB and shouldn't be changed
    ...
    return (
      <div>
        {arrayValues.map((item, idx) => (
          <div key={idx} className="mb-2 d-flex gap-2 property-list-item">
            {isLongText ? (
              <textarea
  ...
  return (
    <>
      <Header 
        ...
        onAuthChange={checkAuthStatus}
      />
      <div id="edit-page-container" className="container">
        <div className="mt-4">
          {/* Title */}
          ...
          {/* Action buttons */}
          <div className="mb-4" id="action-father">
